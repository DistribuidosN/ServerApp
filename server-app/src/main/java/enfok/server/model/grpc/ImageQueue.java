...
public class ImageQueue implements Comparable<ImageQueue> {
    ...
    public ImageQueue(String id, int width, int height, String imageFormat, double filterMultiplier, byte[] imageBytes, List<String> transformations, String filename) {
        this.id = id;
        this.width = width;
        this.height = height;
